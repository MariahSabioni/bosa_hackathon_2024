...
def make_cluster_boxplot(df):
    ...
    fig.update_layout(height=300,title="Violin Plot of total time by cluster", xaxis_title="Cluster", yaxis_title="Total Time")
...
with st.container():
    ...
    with st.expander('Cluster Comparison', expanded=True):
        st.write('''
